...
\While{ventana abierta y cámara entrega frame}{
    ...
    \Switch{$capture\_state$}{
        \Case{``STANDBY''}{
            si $resolved = \text{``5dedos''}$ $\Rightarrow$ pasar a ``CAPTURA''; en otro caso, mostrar ayuda.
        }
        \Case{``CAPTURA''}{
    ...
    \If{$key$ en \{0,1,2,3,4,5,p,-,n\}}{actualizar $current\_label$ según mapeo (0--5 dedos, ok, cool, nook).}
}
